    ...
    <>
      <div className=" flex justify-center flex-row h-1/4 overflow-hidden p-10 ">
        ...
        <div className="basis-1/4 flex flex-col divide-y divide-gray-300 font-mono">
          <button className="w-full hover:bg-violet-300 text-xl border-black-600 h-12">
            HOT DEALS{" "}
          </button>
          <button className="w-full hover:bg-violet-300  text-xl border-black-600 h-12">
            WINTER SALE{" "}
        ...
        <Swiper
          className="w-3/4 h-1/2 basis-3/4 float-right	"
          effect={"cube"}
          grabCursor={true}
          cubeEffect={{
            shadow: true,
        ...
        >
            ...
            >
              <div>
                ...
                <p className="text-5xl font-bold my-4">
                  12MP <span className="font-normal">F/2.3</span>
                </p>
                <p className="text-5xl font-bold">
                  8K <span className="font-normal">VIDEO</span>
                </p>
                <button className="btn btn-wide my-9">Wide</button>
              </div>
              <img
                className="box-border"
                src="https://i.ibb.co/NFYPH2F/slide1-electronic-1.png"
                height="80%"
                alt=""
              />
            </div>
          ...
          <SwiperSlide>
            ...
            >
              <div>
                ...
                <p className="text-5xl font-bold">
                  12K <span className="font-normal">VIDEO</span>
                </p>
                <button className="btn btn-wide my-9">Wide</button>
              </div>
              <img
                src="https://i.ibb.co/mFPtbbf/slide2-electronic1.png"
                alt=""
              />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            ...
            >
              ...
              <img
                src="https://i.ibb.co/FxYgbP4/slide3-electronic1.png"
                alt=""
              />
            </div>
          </SwiperSlide>
